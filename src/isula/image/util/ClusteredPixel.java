...
public class ClusteredPixel {
     ...
     *
     * @param coordinateForX X coordinate.
     * @param coordinateForY Y coordinate.
     * @param imageGraph     Graph representing the image.
